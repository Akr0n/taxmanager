...
- `src/TaxManager.App` — Avalonia 11.3 MVVM. `Program`→`App`(DI)→`MainWindow` (tab Calcolo/Storico/Profili/Informazioni). ViewModels in `ViewModels/`, viste in `Views/`, helper in `Support/`.
